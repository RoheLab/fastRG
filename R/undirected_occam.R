...
#' Create an overlapping continuous community assignment model
#'
...
#'
#' @return An `occam` S3 object, a subclass of the
...
occam <- function(
  ...
  validate_occam(overlapping_sbm)
}

#' @method print occam
#' @export
print.occam <- function(x, ...) {
