...
Note that working with bipartite graphs in `tidygraph` is more complex
than working with one-mode graphs.
...
sample_igraph(ufm)
#> IGRAPH 29f0a36 UN-- 100 236 -- 
#> + attr: name (v/c)
#> + edges from 29f0a36 (vertex names):
