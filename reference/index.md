...
- [`eigs_sym(`*`<undirected_factor_model>`*`)`](https://rohelab.github.io/fastRG/reference/eigs_sym.undirected_factor_model.md)
  : Compute the eigendecomposition of the expected adjacency matrix of
  an undirected factor model
- [`svds(`*`<directed_factor_model>`*`)`](https://rohelab.github.io/fastRG/reference/svds.directed_factor_model.md)
  : Compute the singular value decomposition of the expected adjacency
  matrix of a directed factor model
- [`svds(`*`<undirected_factor_model>`*`)`](https://rohelab.github.io/fastRG/reference/svds.undirected_factor_model.md)
  : Compute the singular value decomposition of the expected adjacency
  matrix of an undirected factor model
- [`expected_edges()`](https://rohelab.github.io/fastRG/reference/expected_edges.md)
  [`expected_degrees()`](https://rohelab.github.io/fastRG/reference/expected_edges.md)
  [`expected_degree()`](https://rohelab.github.io/fastRG/reference/expected_edges.md)
  [`expected_in_degree()`](https://rohelab.github.io/fastRG/reference/expected_edges.md)
  [`expected_out_degree()`](https://rohelab.github.io/fastRG/reference/expected_edges.md)
  [`expected_density()`](https://rohelab.github.io/fastRG/reference/expected_edges.md)
...
- [`plot_expectation()`](https://rohelab.github.io/fastRG/reference/plot_expectation.md)
  [`plot_dense_matrix()`](https://rohelab.github.io/fastRG/reference/plot_expectation.md)
...
- [`sbm()`](https://rohelab.github.io/fastRG/reference/sbm.md) : Create
  an undirected stochastic blockmodel object
